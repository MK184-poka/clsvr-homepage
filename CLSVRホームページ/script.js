...
const activateLogoDraw = () => {
  ...
  window.requestAnimationFrame(() => {
    ...
    document.body.classList.toggle("secret-rare-mode", result.isSecret);
  });
...
const revealTargets = document.querySelectorAll(
  ".section, .quick-links, .line-contact, .booking-form, .notice, .price-card, .area-card, .service-examples > div, .hero-reception-art, .hero-request-art, .service-menu-showcase"
);
